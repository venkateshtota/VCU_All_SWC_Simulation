...
Std_ReturnType Fee_HLPlaceOrder(uint16 Blocknumber_u16,uint16 Offset_u16,uint8 * DataBufferPtr_pu8,uint16 Length_16,Fee_HlMode_ten Mode_en)
{
    Std_ReturnType xRetVal = E_NOT_OK;  /* Function return */
    uint16 xJobType_u16;                /* Fee job type */
    uint16 xJobPrio_u16;                /* Fee job priority */
    uint8  xSecLevel_u8;                /* Fee Security Level */
