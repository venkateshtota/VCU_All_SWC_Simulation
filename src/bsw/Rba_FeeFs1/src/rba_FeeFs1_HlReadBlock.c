...
Fee_stRetVal_ten Fee_HLReadBlock(void)
{
    Fee_stRetVal_ten xRetVal = FEE_ORDER_PENDING_E;     /* Function return */
    Fee_stRetVal_ten xtmpRetVal;                        /* Internal function return */
    ...
    uint16 Offset = 0;                   /* Offset for data tranfer from flash to the user buffer */
    uint16 Length = 0;                   /* Length for data tranfer from flash to the user buffer */
    uint8 * DataPtr;      /* Data pointer for the transfer from flash to the user buffer */
