...
#define BSWM_NO_OF_MRP_DEFERREDREQ                  2
...
#define BSWM_CFG_USERID_BSWM_MRP_SWCMODEREQUEST    2
...
#define BSWM_IDX_BSWM_MRP_BSWM_MDG         1

/* BswMSwcModeNotification - Indexes of BswMSwcModeNotification */
#define BSWM_IDX_BSWM_MRP_SWCMODEREQUEST         2
