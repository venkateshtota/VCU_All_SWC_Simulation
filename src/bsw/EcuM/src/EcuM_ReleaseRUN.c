...

{
    ...
    if(FALSE != EcuM_Prv_IsUserHandlingPossible_b(&User_u16, ECUM_RELEASERUN_APIID))
    {
        if(FALSE != EcuM_Prv_userRUNReqStatus_ab[User_u16])
        {
            /*The request from the user is released */
            EcuM_Prv_userRUNReqStatus_ab[User_u16] = FALSE;
