...
Com_IpduGroupVector BswM_IPduGrpVctr_ReinitTrue_au8;
/* PDU group vector which holds the information of all the  PDu Groups */
Com_IpduGroupVector BswM_IPduGrpVctr_ReinitAll_au8;
...
)
{
   ...
   if ( FALSE != BswM_PduGrpSwt_b )
   {
      ...
      for(idx_u8 = 0;idx_u8 < (sizeof(BswM_IPduGrpVctr_ReinitTrue_au8)/sizeof(BswM_IPduGrpVctr_ReinitTrue_au8[0])) ;idx_u8++)
      {
