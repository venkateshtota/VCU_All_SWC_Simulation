...
Std_ReturnType Fee_CheckModuleSt(uint8 ApiId_u8)
{
    Std_ReturnType xRetVal = E_OK;      /* Function return */
 ...
 *********************************************************************
 */
Std_ReturnType Fee_CheckBlockCfg(uint8  ApiId_u8, uint16 BlockNum_u16)
{
    Std_ReturnType xRetVal = E_OK;  /* Function return */
 ...
 *********************************************************************
 */
Std_ReturnType Fee_CheckAdrPtr(uint8 ApiId_u8, const uint8 * DataBufferPtr_pcu8)
{
    Std_ReturnType xRetVal = E_OK;      /* Function return */
 ...
 *********************************************************************
 */
Std_ReturnType Fee_CheckBlkOfs(uint8 ApiId_u8, uint16 BlockNum_u16, uint16 BlockOfs_u16)
{
    Std_ReturnType xRetVal = E_OK;  /* Function return */
 ...
 *********************************************************************
 */
Std_ReturnType Fee_CheckBlkLen(uint8 ApiId_u8, uint16 BlockNum_u16, uint16 BlockOfs_u16, uint16 BlockLen_u16)
{
    Std_ReturnType xRetVal = E_OK;      /* Function return */
