...
)
{
    ...
    uint16 idx_u16 = 0;
    BswM_Cfg_MRPSdClientServType_tst dataSdClientSrvCS_st;
    boolean flgSdClientServiceHandleIdValid = FALSE;
...
)
{
    ...
    uint16 idx_u16 = 0;
    BswM_Cfg_MRPSdConsEventGrpType_tst dataSdConsEvntGrpCS_st;
    boolean flgSdConsumedEventGroupHandleIdValid = FALSE;
    boolean flgDetChecksPassed_b = FALSE;
...

{
    ...
    uint16 idx_u16 = 0;
    BswM_Cfg_MRPSdEventType_tst dataSdEvntHndrCS_st;
    boolean flgEventHandlerHandleIdValid = FALSE;
    boolean flgDetChecksPassed_b = FALSE;
