...
typedef struct
{
    ...
    Fee_Prv_DbgTimeEntry_tst orderMaintain_st;
    Fee_Prv_DbgTimeEntry_tst orderRead_st;
    Fee_Prv_DbgTimeEntry_tst orderWrite_st;
    Fee_Prv_DbgTimeEntry_tst orderInit_st;
    Fee_Prv_DbgTimeEntry_tst procMain_st;
    Fee_Prv_DbgTimeEntry_tst secChngDat_st;
    Fee_Prv_DbgTimeEntry_tst secChngFat_st;
    Fee_Prv_DbgTimeEntry_tst freeUse00_st;
    Fee_Prv_DbgTimeEntry_tst freeUse01_st;
    Fee_Prv_DbgTimeEntry_tst freeUse02_st;
    Fee_Prv_DbgTimeEntry_tst freeUse03_st;
    Fee_Prv_DbgTimeEntry_tst freeUse04_st;
} Fee_Prv_DgbTime_tst;

typedef struct
{
    uint32 sectorDeleteAbs_au32    [FEE_NUM_FLASH_BANKS_AVAILABLE];
    uint32 sectorDeleteDelta_aau32 [FEE_NUM_FLASH_BANKS_AVAILABLE][FEE_PRV_CFG_DBG_ERASECOUNTERS_HISTOGRAM_BASKETNUM];
...
extern void Fee_Prv_DbgInit(void);
#define FEE_STOP_SEC_CODE
#include "Fee_MemMap.h"
#  else
#define Fee_Prv_DbgMainFunction()   Fee_Prv_DbgDummyFunc()
#define Fee_Prv_DbgInit()           Fee_Prv_DbgDummyFunc()
#  endif
...
#define FEE_START_SEC_CODE
#include "Fee_MemMap.h"
extern void Fee_Prv_DbgCheckFatEntries(void);
#define FEE_STOP_SEC_CODE
#include "Fee_MemMap.h"

#  else

#define Fee_Prv_DbgCheckFatEntries()    Fee_Prv_DbgDummyFunc()
